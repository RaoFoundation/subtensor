...
//! Shared fixtures and numeric helpers for epoch integration tests.
...
#[allow(dead_code)]
pub(super) fn inplace_normalize(x: &mut [I32F32]) {
...
#[allow(dead_code)]
pub(super) fn normalize_weights(mut weights: Vec<u16>) -> Vec<u16> {
...
#[allow(dead_code)]
pub(super) fn uid_stats(netuid: NetUid, uid: u16) {
    log::info!(
        "stake: {:?}",
