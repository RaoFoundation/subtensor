...
| `runtime/` | Composes the pallets into the actual runtime (`construct_runtime!`), plus migrations, runtime APIs, and the [`spec_version`](/code/runtime/src/lib.rs#L238) (`runtime/src/lib.rs`) — bump it to ship a release |
...
| `docs/` | This documentation — the single source of truth, rendered to bittensor.com/docs by the website app. `docs/tx/`, `docs/query/`, and `docs/errors/` are generated; never hand-edit them |
