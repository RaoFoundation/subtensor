...
| `docs/` | This documentation — the single source of truth, rendered to docs.bittensor.com by the website app. `docs/tx/`, `docs/query/`, and `docs/errors.mdx` are generated; never hand-edit them |
