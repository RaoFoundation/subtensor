...
| testnet | `testnet` | environment reviewers (one-click approval), then smoke suite |
| SDK rc | `pypi` | environment reviewers (separate approval), then SDK release candidate to PyPI |
