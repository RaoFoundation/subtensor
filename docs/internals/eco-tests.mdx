...
maps, and runtime APIs like [`DelegateInfoRuntimeApi`](/code/pallets/subtensor/runtime-api/src/lib.rs#L27-L31) and
[`StakeInfoRuntimeApi`](/code/pallets/subtensor/runtime-api/src/lib.rs#L67-L76). If a runtime change renames a storage item, changes a
