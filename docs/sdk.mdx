...
```python
sub.block                                       # blocking
sub.finalized_block                             # latest finalized block
...
sub.collateral.collateral_policy(netuid=1)      # lock share + drain ratio
...
# Miner collateral (spec >= 435): bt.AddCollateral / bt.SetMinCollateral
