...
The chain's Rust source is browsable at `/code/<repo path>` (e.g.
[`/code/pallets/subtensor/src/lib.rs`](/code/pallets/subtensor/src/lib.rs)),
with `#L12` / `#L12-L34` line anchors that highlight the span; a
machine-readable file index is at [`/code/index.json`](/code/index.json), and
plain text at `/code/raw/<path>`.
