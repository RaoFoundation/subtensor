...
Storage is [`MaxDifficulty`](/code/pallets/subtensor/src/lib.rs#L2150) in
`pallets/subtensor/src/lib.rs`, accessed via
[`get_max_difficulty`](/code/pallets/subtensor/src/utils/misc.rs#L500-L502) /
[`set_max_difficulty`](/code/pallets/subtensor/src/utils/misc.rs#L503-L506)
...
`u64::MAX / 4` ([`SubtensorInitialMaxDifficulty`](/code/runtime/src/lib.rs#L814)
...
Owner-settable (the AdminUtils extrinsic
[`sudo_set_max_difficulty`](/code/pallets/admin-utils/src/lib.rs#L308-L334)
accepts
