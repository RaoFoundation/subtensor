...
([`pallets/subtensor/src/epoch/run_epoch.rs`](/code/pallets/subtensor/src/epoch/run_epoch.rs#L276-L282)):
[`is_topk_nonzero(&stake, k)`](/code/pallets/subtensor/src/epoch/math.rs#L227-L241)
...
([`sudo_set_max_allowed_validators`](/code/pallets/admin-utils/src/lib.rs#L848-L873)
in AdminUtils requires the root origin
