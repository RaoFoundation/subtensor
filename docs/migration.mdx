...
| `claim_root(wallet, netuids)` | `bt.ClaimRoot()` — parameterless since v438 (fund-level, [beta baskets](/docs/guides/root-reborn)) |
...
| `stake set-claim` / `process-claim` | `btcli tx claim-root` (parameterless since v438; `set-claim` removed — see [Root Reborn](/docs/guides/root-reborn)) |
