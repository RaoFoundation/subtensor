...
- **Subnet ownership.** For subnets at least one year old, ownership transfers
  ...
  eligible alpha: `SubnetAlphaOut - SubnetProtocolAlpha - AlphaBurned`, with
  saturating subtraction. A zero eligible balance cannot trigger a transfer.
  Existing conviction counts toward this threshold. See
