...
| other `get_root_claim*` reads | `client.staking.root_basket_owed(coldkey_ss58=...)` and the other [beta basket reads](/docs/guides/root-reborn) |
...
| `claim_root(wallet, netuids)` | `bt.ClaimRoot()` — parameterless since v441 (fund-level, [beta baskets](/docs/guides/root-reborn)) |
