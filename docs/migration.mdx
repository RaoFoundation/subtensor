...
| `unstake_multiple` | `bt.RemoveStakes(positions=[bt.StakeRemoval(...), ...])` (atomic) |
...
| `stake remove --include-hotkeys` / `--all-hotkeys` | `stake remove-many --positions '<json>'` / `tx remove-stakes` (atomic) |
