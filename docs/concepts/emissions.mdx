...
**EMA price**, weighted by a miner-burn penalty
([`get_shares`](/code/pallets/subtensor/src/coinbase/subnet_emissions.rs#L354-L389);
this price-based formula shipped in June 2026):
...
A [`root_proportion`](/code/pallets/subtensor/src/coinbase/block_step.rs#L69-L79) share of the validator half (same formula as the
...
per block ([`MaxEpochsPerBlock`](/code/pallets/subtensor/src/lib.rs#L2181)) —
