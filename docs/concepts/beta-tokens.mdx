...
**Normalization** splices each fund onto that line the day it first
appears, the way a new share class of a mutual fund launches at today’s
NAV instead of at $1:

- A **baseline** is stamped: `raw price at first sighting / index that
  day`.
