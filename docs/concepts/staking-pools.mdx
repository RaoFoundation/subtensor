...
constant-product AMM): two reserves, TAO ([`SubnetTAO`](/code/pallets/subtensor/src/lib.rs#L1377)) and alpha
([`SubnetAlphaIn`](/code/pallets/subtensor/src/lib.rs#L1419)), plus a pair of weights $w_1 + w_2 = 1$. The spot price
([`calculate_price`](/code/pallets/swap/src/pallet/balancer.rs#L220-L228)) is
...
The math lives in [`pallets/swap/src/pallet/balancer.rs`](/code/pallets/swap/src/pallet/balancer.rs); quotes over RPC use
...
- **The fee comes off the input side first.** Amount × [`FeeRate`](/code/pallets/swap/src/pallet/mod.rs#L96)/65535
...
- **The swap updates both reserves.** Your TAO enters `SubnetTAO`, alpha
  ...
  ([`SubnetAlphaOut`](/code/pallets/subtensor/src/lib.rs#L1424)). The price after your trade is the new reserve ratio —
...
([`InsufficientLiquidity`](/code/pallets/swap/src/pallet/mod.rs#L151)).
