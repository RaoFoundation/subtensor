...
description: What runtime v459 basket trading means if you stake on root — nothing to do, what stays the same, how to see what your validator holds and trades, what the guardrails protect, and how to move if you disagree.
---
...
v459 lets the validator actively trade that basket with
...
and therefore what your beta is worth when you claim. Before v459 the NAV
