...
This bound assumes pools near the 0.5 balancer-weight equilibrium; if a
pool's balancer weights skew far from equilibrium, the price-impact
estimate behind the 9% figure, and so the daily figure, becomes less
