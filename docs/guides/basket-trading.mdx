...
**Basket trading** (runtime v459) lets a root validator actively manage the
...
For what changed on chain in v459, see the
[release notes](/releases/v459-upgrade). Two companion pages cover the other
...
proxy. Runtime v459 adds a proxy type for exactly this:
...
- Release: [v459 — Basket Trading](/releases/v459-upgrade)
