...
accrued τ is fund yield. List your positions, then claim accrued yield — one
parameterless claim covers every validator you root-stake to, paying out in
TAO staked back to root (redeeming past your staked τ also claims accrued
yield automatically):
...
btcli tx claim-root -w my_coldkey                 # claim accrued yield across all validators
```
