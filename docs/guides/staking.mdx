...
which it manages by trading holdings, and root stakers accrue an entitlement
to that fund in proportion to their root stake.
...
validator-side rebalancing command, and migration notes from the retired
