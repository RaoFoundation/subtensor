...
with `--exclude-hotkeys validator-c,validator-d`.
...
This replaces the SDK's pre-v11 `unstake_multiple` helper. Unlike its
sequence of independent transactions, the new operation is
