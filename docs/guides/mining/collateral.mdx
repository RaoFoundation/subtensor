...
- [`add_collateral`](/code/pallets/subtensor/src/subnets/collateral.rs)
  locks about the given TAO-value of additional collateral on your own
  hotkey: free alpha already staked there is used first (at the subnet
  moving price), and only the shortfall is bought with TAO. Same lock, same
  drain, same persistence across deregistration and credit on
  re-registration.
