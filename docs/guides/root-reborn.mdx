...
Runtime v450 opened the gate and pinned the concentration cap
...
Weights steer where *new* dividends go. Since runtime v456 a validator can
also rebalance positions already in the fund with
[`swap-basket`](/docs/tx/swap-basket), through a dedicated `BasketTrading`
proxy and under a set of price, budget, and concentration guardrails; see
