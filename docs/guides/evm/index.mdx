...
<Cards>
  <Card
    title="Precompiles"
    description="Deployed addresses, current coverage, and the proposed typed EVM surface."
    href="/docs/guides/evm/precompiles"
  />
  <Card
  ...
  <Card
    ...
    description="Compatibility, function versioning, deprecation, and reversible disablement."
    href="/docs/guides/evm/precompile-design"
  />
  <Card
