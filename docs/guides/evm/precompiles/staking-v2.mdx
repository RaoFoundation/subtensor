...
| `setTxChildkeyTakeRateLimit` | `SubtensorModule.sudo_set_tx_childkey_take_rate_limit` |
| `setMinChildkeyTake` | `SubtensorModule.sudo_set_min_childkey_take` |
| `setMaxChildkeyTake` | `SubtensorModule.sudo_set_max_childkey_take` |
...
| `setNumRootClaims` | `SubtensorModule.sudo_set_num_root_claims` |
...
| Proposed function | Source extrinsic |
|---|---|
| `setDefaultTake` | `AdminUtils.sudo_set_default_take` |
| `setStakeThreshold` | `AdminUtils.sudo_set_stake_threshold` |
| `setNominatorMinRequiredStake` | `AdminUtils.sudo_set_nominator_min_required_stake` |
| `setDelegateTakeRateLimit` | `AdminUtils.sudo_set_tx_delegate_take_rate_limit` |
| `setMinDelegateTake` | `AdminUtils.sudo_set_min_delegate_take` |
