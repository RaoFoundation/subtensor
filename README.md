...
**Full documentation:** [docs.bittensor.com](https://docs.bittensor.com)
...
| Native crypto | [`py-sp-core/`](./py-sp-core/) | PyO3 bindings around `sp-core` (keypairs, signing) — the SDK's wallet crypto, built against the same revision as the chain. |
...
| Documentation | [`docs/`](./docs/) | Source for docs.bittensor.com. `docs/tx/`, `docs/query/`, and `docs/errors.mdx` are generated — do not hand-edit. |
...
Deeper map: [Repository layout](https://docs.bittensor.com/docs/internals/repo-layout).
...
2. **Docs generated from the same registries.** Transaction, query, and error
   ...
   docs.bittensor.com always matches what `btcli` and `import bittensor` expose.

3. **CI validates the whole stack.** On every PR, Rust checks run alongside a
   [mainnet-clone upgrade](https://docs.bittensor.com/docs/internals/mainnet-clone)
...
4. **Release train.** Merging to `main` builds the runtime once (deterministic
   ...
   [Release process](https://docs.bittensor.com/docs/internals/release-process).
...
|--------------|------------|
| Install the SDK and run your first query/tx | [Quickstart](https://docs.bittensor.com/docs/quickstart) |
| Use `btcli` or the Python API day-to-day | [CLI](https://docs.bittensor.com/docs/cli) · [SDK README](./sdk/python/README.md) |
| Build an agent on top of the chain | [For agents](https://docs.bittensor.com/docs/agents) · [`/catalog/intents.json`](https://docs.bittensor.com/catalog/intents.json) |
| Understand subnets, TAO, epochs, wallets | [Concepts](https://docs.bittensor.com/docs/concepts/network) |
| Run a local chain for development | [Local development](https://docs.bittensor.com/docs/guides/local-development) |
| Operate a mainnet/testnet node | [Subtensor nodes](https://docs.bittensor.com/subtensor-nodes) |
| Develop or change the chain/runtime | [Rust setup](https://docs.bittensor.com/docs/internals/rust-setup) · [Testing](https://docs.bittensor.com/docs/internals/testing) |
| Contribute a PR | [Contributing](https://docs.bittensor.com/docs/internals/contributing) · [CONTRIBUTING.md](./CONTRIBUTING.md) |
...
[local development](https://docs.bittensor.com/docs/guides/local-development)
...
[Transactions](https://docs.bittensor.com/docs/tx) ·
[Queries](https://docs.bittensor.com/docs/query).

### Minimal SDK dev (from this repo)

```bash
cd sdk/python
just sync    # uv environment; builds py-sp-core from ../py-sp-core
just check   # lint, typecheck, unit tests, codegen gates (same as CI)
```

End-to-end tests against a running localnet: `just e2e`. See
[SDK tests](https://docs.bittensor.com/docs/internals/sdk-tests).
...
- **EVM**: Substrate accounts (ss58) and EVM accounts (h160) are separate
  ...
  into Solidity. Guide: [EVM](https://docs.bittensor.com/docs/guides/evm).
- **Networks**: `finney` (mainnet), `test` (testnet), `local` (dev node).
  Public endpoints and lite vs archive nodes:
  [The network](https://docs.bittensor.com/docs/concepts/network).
...
[Contributing](https://docs.bittensor.com/docs/internals/contributing).
