...
const releases: Release[] = [
  {
    ...
    summary:
      ...
      'subnet’s own pool. No synthetic tokens, nothing minted or burned, no expiry: the pool rents ' +
      'out at most 10% of itself at 20% a year, fixed at open and paid to the pool. btcli deriv ' +
