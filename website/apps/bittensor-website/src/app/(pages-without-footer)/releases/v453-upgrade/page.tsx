...
export const metadata: Metadata = {
  title: 'The V453 Upgrade — Longs and Shorts',
  description:
    'V453 adds pallet-derivatives: 30-day longs and shorts on any subnet’s alpha, borrowed ' +
  ...
  alternates: {canonical: '/releases/v453-upgrade'},
};
    ...
    <Suspense fallback={<div style={{minHeight: '100vh', backgroundColor: 'white'}} />}>
      <FadeInWrapper className={styles.page_container}>
        <section className={styles.title_section}>
          <h1 className={styles.paper_title}>The V453 Upgrade</h1>
