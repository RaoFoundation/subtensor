...
export const rustCore = Object.freeze({
  ...
  keyfiles: Object.freeze({
    ...
    decrypt_keyfile_data: keys.decrypt_keyfile_data,
    ...
    get_password_from_environment: keys.get_password_from_environment,
    savePasswordToEnvironment: keys.savePasswordToEnvironment,
    save_password_to_environment: keys.save_password_to_environment,
  }),
  codec: Object.freeze({
    value: Object.freeze({
