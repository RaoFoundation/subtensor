...
RAW_ONLY: dict[str, set[str]] = {
    "SubtensorModule": {
        ...
        # PoW registration — out of scope by design. The faucet is testnet-only
        # and absent from this production metadata catalog.
        "register",
    ...
    "AdminUtils": {
        ...
        # emission gate tuning (v440/v441) — root-only, no semantic wrapper
        "sudo_set_emission_bar_quantile",
        "sudo_set_emission_bar_rank",
