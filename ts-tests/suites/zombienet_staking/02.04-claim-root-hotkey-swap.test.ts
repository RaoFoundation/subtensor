...
// to accumulate from dividends landing in place on both subnets.
async function setupTwoSubnetsWithBasket(
    ...
    // Register oldHotkey on the root subnet: its root dividends accumulate in its fund as
    // alpha on the subnets they are earned on.
...
describeSuite({
    id: "0204_swap_hotkey_basket_fund",
