...
function decodeLockState(lockState): { lockedMass: bigint; conviction: string; convictionBits: bigint; lastUpdate: bigint } {
...
function fixedMulDivToBigInt(
  multiplier: { numerator: bigint; denominator: bigint },
  value: bigint,
  divisor: { numerator: bigint; denominator: bigint },
): bigint {
